...
DataSFusion::DataSFusion()
{
    ...
    m_time = 0;
    // m_gyrX com.eprosima.idl.parser.typecode.PrimitiveTypeCode@13eb8acf
    m_gyrX = 0.0;
    // m_gyrY com.eprosima.idl.parser.typecode.PrimitiveTypeCode@51c8530f
    m_gyrY = 0.0;
    // m_gyrZ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7403c468
    m_gyrZ = 0.0;
    // m_accX com.eprosima.idl.parser.typecode.PrimitiveTypeCode@43738a82
    m_accX = 0.0;
    // m_accY com.eprosima.idl.parser.typecode.PrimitiveTypeCode@c81cdd1
    m_accY = 0.0;
    // m_accZ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1fc2b765
    m_accZ = 0.0;
    // m_magX com.eprosima.idl.parser.typecode.PrimitiveTypeCode@75881071
    m_magX = 0.0;
    // m_magY com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2a70a3d8
    m_magY = 0.0;
    // m_magZ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@289d1c02
    m_magZ = 0.0;
    // m_temp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@22eeefeb
    m_temp = 0.0;
    // m_press com.eprosima.idl.parser.typecode.PrimitiveTypeCode@17d0685f
    m_press = 0.0;
    // m_phi com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3891771e
    m_phi = 0.0;
    // m_the com.eprosima.idl.parser.typecode.PrimitiveTypeCode@78ac1102
    m_the = 0.0;
    // m_psi com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2de8284b
    m_psi = 0.0;
    // m_q0 com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12c8a2c0
    m_q0 = 0.0;
    // m_q1 com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1990a65e
    m_q1 = 0.0;
    // m_q2 com.eprosima.idl.parser.typecode.PrimitiveTypeCode@64485a47
    m_q2 = 0.0;
    // m_q3 com.eprosima.idl.parser.typecode.PrimitiveTypeCode@25bbf683
    m_q3 = 0.0;
    // m_posN com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6ec8211c
    m_posN = 0.0;
    // m_posE com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7276c8cd
    m_posE = 0.0;
    // m_posD com.eprosima.idl.parser.typecode.PrimitiveTypeCode@544a2ea6
    m_posD = 0.0;
    // m_speedN com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2e3fc542
    m_speedN = 0.0;
    // m_speedE com.eprosima.idl.parser.typecode.PrimitiveTypeCode@150c158
    m_speedE = 0.0;
    // m_speedD com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4524411f
    m_speedD = 0.0;
    // m_windN com.eprosima.idl.parser.typecode.PrimitiveTypeCode@401e7803
    m_windN = 0.0;
    // m_windE com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10dba097
    m_windE = 0.0;
    // m_windD com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1786f9d5
    m_windD = 0.0;
    // m_ssa com.eprosima.idl.parser.typecode.PrimitiveTypeCode@704d6e83
    m_ssa = 0.0;
    // m_aoa com.eprosima.idl.parser.typecode.PrimitiveTypeCode@43a0cee9
    m_aoa = 0.0;
    // m_gamma com.eprosima.idl.parser.typecode.PrimitiveTypeCode@eb21112
    m_gamma = 0.0;
    // m_alive com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2eda0940
    m_alive = false;
