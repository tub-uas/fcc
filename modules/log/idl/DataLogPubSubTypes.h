...
#error Generated DataLog is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 * @ingroup DATALOG
 */
class DataLogPubSubType : public eprosima::fastrtps::TopicDataType {
public:
