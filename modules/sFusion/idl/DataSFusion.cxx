...
{
    // m_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1ea9f6af
    m_time = 0;
    // m_gyrX com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a192cfe
    m_gyrX = 0.0;
    // m_gyrY com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5119fb47
    m_gyrY = 0.0;
    // m_gyrZ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7193666c
    m_gyrZ = 0.0;
    // m_accX com.eprosima.idl.parser.typecode.PrimitiveTypeCode@20deea7f
    m_accX = 0.0;
    // m_accY com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3835c46
    m_accY = 0.0;
    // m_accZ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1dde4cb2
    m_accZ = 0.0;
    // m_magX com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7714e963
    m_magX = 0.0;
    // m_magY com.eprosima.idl.parser.typecode.PrimitiveTypeCode@20ce78ec
    m_magY = 0.0;
    // m_magZ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@393671df
    m_magZ = 0.0;
    // m_temp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@56620197
    m_temp = 0.0;
    // m_press com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6eda5c9
    m_press = 0.0;
    // m_phi com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55b7a4e0
    m_phi = 0.0;
    // m_the com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5f058f00
    m_the = 0.0;
    // m_psi com.eprosima.idl.parser.typecode.PrimitiveTypeCode@192d43ce
    m_psi = 0.0;
    // m_q0 com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6973b51b
    m_q0 = 0.0;
    // m_q1 com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6e171cd7
    m_q1 = 0.0;
    // m_q2 com.eprosima.idl.parser.typecode.PrimitiveTypeCode@402bba4f
    m_q2 = 0.0;
    // m_q3 com.eprosima.idl.parser.typecode.PrimitiveTypeCode@795cd85e
    m_q3 = 0.0;
    // m_posN com.eprosima.idl.parser.typecode.PrimitiveTypeCode@59fd97a8
    m_posN = 0.0;
    // m_posE com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f5ac9e4
    m_posE = 0.0;
    // m_posD com.eprosima.idl.parser.typecode.PrimitiveTypeCode@123ef382
    m_posD = 0.0;
    // m_speedN com.eprosima.idl.parser.typecode.PrimitiveTypeCode@dbf57b3
    m_speedN = 0.0;
    // m_speedE com.eprosima.idl.parser.typecode.PrimitiveTypeCode@384ad17b
    m_speedE = 0.0;
    // m_speedD com.eprosima.idl.parser.typecode.PrimitiveTypeCode@61862a7f
    m_speedD = 0.0;
    // m_windN com.eprosima.idl.parser.typecode.PrimitiveTypeCode@441772e
    m_windN = 0.0;
    // m_windE com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7334aada
    m_windE = 0.0;
    // m_windD com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1d9b7cce
    m_windD = 0.0;
    // m_ssa com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4d9e68d0
    m_ssa = 0.0;
    // m_aoa com.eprosima.idl.parser.typecode.PrimitiveTypeCode@42e99e4a
    m_aoa = 0.0;
    // m_gamma com.eprosima.idl.parser.typecode.PrimitiveTypeCode@14dd9eb7
    m_gamma = 0.0;
    // m_alive com.eprosima.idl.parser.typecode.PrimitiveTypeCode@52e6fdee
    m_alive = false;
