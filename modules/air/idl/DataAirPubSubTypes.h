...
#error Generated DataAir is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 * @ingroup DATAAIR
 */
class DataAirPubSubType : public eprosima::fastrtps::TopicDataType {
public:
