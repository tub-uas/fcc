...
#error Generated DataGps is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 * @ingroup DATAGPS
 */
class DataGpsPubSubType : public eprosima::fastrtps::TopicDataType {
public:
