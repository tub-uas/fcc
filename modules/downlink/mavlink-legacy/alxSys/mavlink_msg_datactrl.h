 ...
 *
 * @param time  Time.
 * @param xi  ailleron (ctrl).
 * @param eta  elevator (ctrl).
 * @param zeta  rudder (ctrl).
 * @param etaT  thrust (ctrl).
 * @param etaF  flaps (ctrl).
 * @param alive  alive.
