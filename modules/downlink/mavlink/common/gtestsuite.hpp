...
TEST(common, GIMBAL_DEVICE_INFORMATION)
{
    ...
    packet_in.tilt_max = 157.0;
    packet_in.tilt_min = 185.0;
    packet_in.tilt_rate_max = 213.0;
    packet_in.pan_max = 241.0;
    packet_in.pan_min = 269.0;
    packet_in.pan_rate_max = 297.0;
