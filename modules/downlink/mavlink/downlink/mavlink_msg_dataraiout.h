...
#define MAVLINK_MSG_ID_DataRaiOut_CRC 187
#define MAVLINK_MSG_ID_15000_CRC 187
...
#define MAVLINK_MESSAGE_INFO_DataRaiOut { \
    ...
    {  { "time", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_dataraiout_t, time) }, \
         { "chnl", NULL, MAVLINK_TYPE_UINT16_T, 12, 24, offsetof(mavlink_dataraiout_t, chnl) }, \
 ...
 * @param roll  Roll command from fcc
 * @param pitch  Pitch command from fcc
 * @param yaw  Yaw command from fcc
 * @param thr  Thr command from fcc
...
static inline uint16_t mavlink_msg_dataraiout_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time, const uint16_t *chnl, float roll, float pitch, float yaw, float thr, uint16_t fltMode, uint8_t alive)
{
    ...
    _mav_put_uint16_t_array(buf, 24, chnl, 12);
...
{
    return mavlink_msg_dataraiout_pack(system_id, component_id, msg, dataraiout->time, dataraiout->chnl, dataraiout->roll, dataraiout->pitch, dataraiout->yaw, dataraiout->thr, dataraiout->fltMode, dataraiout->alive);
}
...
{
    return mavlink_msg_dataraiout_pack_chan(system_id, component_id, chan, msg, dataraiout->time, dataraiout->chnl, dataraiout->roll, dataraiout->pitch, dataraiout->yaw, dataraiout->thr, dataraiout->fltMode, dataraiout->alive);
}
...
static inline void mavlink_msg_dataraiout_send(mavlink_channel_t chan, uint64_t time, const uint16_t *chnl, float roll, float pitch, float yaw, float thr, uint16_t fltMode, uint8_t alive)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_DataRaiOut_LEN];
    _mav_put_uint64_t(buf, 0, time);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_dataraiout_send(chan, dataraiout->time, dataraiout->chnl, dataraiout->roll, dataraiout->pitch, dataraiout->yaw, dataraiout->thr, dataraiout->fltMode, dataraiout->alive);
#else
 ...
 */
static inline void mavlink_msg_dataraiout_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time, const uint16_t *chnl, float roll, float pitch, float yaw, float thr, uint16_t fltMode, uint8_t alive)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_uint16_t_array(msg, chnl, 12,  24);
}

/**
 * @brief Get field roll from dataraiout message
 *
 * @return  Roll command from fcc
 */
