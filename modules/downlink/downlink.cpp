...
void Downlink::run() {
	...
	while (1) {
		...
		if (listener.newDataSFusion &&
			...
			msg_sfusion.p = listener.dataSFusion.p();
			msg_sfusion.q = listener.dataSFusion.q();
			msg_sfusion.r = listener.dataSFusion.r();
			msg_sfusion.a_x = listener.dataSFusion.a_x();
			msg_sfusion.a_y = listener.dataSFusion.a_y();
			msg_sfusion.a_z = listener.dataSFusion.a_z();
			msg_sfusion.true_airspeed = listener.dataSFusion.true_airspeed();
			msg_sfusion.indicated_airspeed = listener.dataSFusion.indicated_airspeed();
			msg_sfusion.density = listener.dataSFusion.density();
		...
		if (listener.newDataAir &&
			...
			msg_air.dynamic_pressure = listener.dataAir.dynamic_pressure();
		...
		if (listener.newDataGps &&
			...
			msg_gps.latitude = listener.dataGps.latitude();
			msg_gps.longitude = listener.dataGps.longitude();
			msg_gps.alt_msl = listener.dataGps.alt_msl();
		...
		if (listener.newDataCtrl &&
			...
			msg_ctrl.xi_setpoint = listener.dataCtrl.xi_setpoint();
			msg_ctrl.eta_setpoint = listener.dataCtrl.eta_setpoint();
			msg_ctrl.zeta_setpoint = listener.dataCtrl.zeta_setpoint();
			msg_ctrl.throttle_setpoint = listener.dataCtrl.throttle_setpoint();
			msg_ctrl.flaps_setpoint = listener.dataCtrl.flaps_setpoint();
			msg_ctrl.roll_setpoint = listener.dataCtrl.roll_setpoint();
			msg_ctrl.roll_rate_setpoint = listener.dataCtrl.roll_rate_setpoint();
			msg_ctrl.pitch_setpoint = listener.dataCtrl.pitch_setpoint();
			msg_ctrl.pitch_rate_setpoint = listener.dataCtrl.pitch_rate_setpoint();
			msg_ctrl.yaw_setpoint = listener.dataCtrl.yaw_setpoint();
			msg_ctrl.yaw_rate_setpoint = listener.dataCtrl.yaw_rate_setpoint();
			msg_ctrl.tas_setpoint = listener.dataCtrl.tas_setpoint();
			msg_ctrl.tas_rate_setpoint = listener.dataCtrl.tas_rate_setpoint();
			msg_ctrl.hgt_setpoint = listener.dataCtrl.hgt_setpoint();
			msg_ctrl.hgt_rate_setpoint = listener.dataCtrl.hgt_rate_setpoint();
			msg_ctrl.flight_mode = listener.dataCtrl.flight_mode();
			msg_ctrl.flight_fct = listener.dataCtrl.flight_fct();
